# Update all recipe HTML files with master template styling
...
foreach ($recipe in $recipes) {
    $file = Join-Path $path "$recipe.html"
    if (Test-Path $file) {
        $name = ($recipe -replace '-', ' ').ToTitle()
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            ...
            background-image: url('./logodes.jpeg');
    ...
    <div class="recipe-container">
        ...
        <div class="ingredients-section">
            ...
            <div class="ingredient-grid">
                ...
                <div class="ingredient-item"><div class="ingredient-icon">🍅</div><div class="ingredient-text">Tomatoes (fresh or puree)</div></div>
            </div>
        </div>
...
Write-Host "All pages now have master template design with ingredient icons!"
